...
namespace SE.Pedidos.Infra.Migrations
{
    ...
    [Migration("20220614224945_Pedidos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SE.Pedidos.Domain.Pedidos.Pedido", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SE.Pedidos.Domain.Pedidos.PedidoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SE.Pedidos.Domain.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SE.Pedidos.Domain.Pedidos.Pedido", b =>
                {
                    b.HasOne("SE.Pedidos.Domain.Voucher", "Voucher")
                        .WithMany()
                        .HasForeignKey("VoucherId");

                    b.OwnsOne("SE.Pedidos.Domain.Pedidos.Endereco", "Endereco", b1 =>
                        {
            ...
            modelBuilder.Entity("SE.Pedidos.Domain.Pedidos.PedidoItem", b =>
                {
                    b.HasOne("SE.Pedidos.Domain.Pedidos.Pedido", "Pedido")
